...
var travel5 = travelInterface(id: UUID(), title: "오사카", startDate: "2023.02.21", endDate: "2023.02.24", isPublic: false, titleimg: Image("osaka"), bucketList:  [bucket5, bucket6, bucket7], happyList: ["한번도 본 적 없는 음식을 시켜서 먹어봤다."], sadList: ["즉흥적으로 간 거라 유니버셜 티켓을 못 끊었더니 놀이기구 타는 데 줄을 한참 동안 서야했다."])
...
var travel8 = travelInterface(id: UUID(), title: "독일", startDate: "2024.01.22", endDate: "2024.01.25", isPublic: false, titleimg: Image("germany"), bucketList:  [bucket9, bucket10, bucket4, bucket3, bucket1], happyList: ["뮌헨 경기 직관!!!!!!!!!!!!!"], sadList: ["뮌헨 경기를 하나 더 보고싶었는데 미리 티켓팅을 안 했어서 아쉬웠다."])
...
var bucket9 = bucketInterface(id: 8, bucketTitle: "베를린 벽 구경하기", bucketImg: "germany_wall", bucketDesct: "뮌헨 경기 다음으로 꼭 보고싶었던 베를린 벽..", isComplete: false)
var bucket10 = bucketInterface(id: 9, bucketTitle: "뮌헨 경기 직관", bucketImg: "munchen", bucketDesct: "김민재 봐야지ㅠㅠ", isComplete: true, satisfactLevel: 5, bucketReview: "드디어 그렇게 바라던 뮌헨 경기....ㅠㅠㅠ 하나만 티켓팅한게 정말... 가문의 수치다.")
