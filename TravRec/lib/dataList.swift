...
var travel0 = travelInterface(id: UUID(), title: "영국", startDate: "2023.03.04", endDate: "2023.03.19", isPublic: false, titleimg: Image("travrec_logo"), bucketList: [bucket1,bucket2,bucket3,bucket4], happyList: [], sadList: [])
