...
//    }
    ...
    var body: some View {
        ...
        VStack(alignment: .leading, spacing: 30) {
            ...
            .navigationTitle("아쉬웠던 기억 추가")
            .padding(.top, 30)
            
            VStack(alignment:.leading) {
                Text("아쉬웠던 기억").font(.title3)
                TextField("아쉬웠던 기억", text: $sadInput)
                    .font(.caption)
            ...
            Button(action: {
                travelObj.sadList.append(sadInput)
                
                self.presentationMode.wrappedValue.dismiss()
            }, label: {
                Label(
                    title: { Text("아쉬웠던 기억 추가하기") },
